...
biasData = readtable("log\XSens_07_02_1706.csv");
...
raw_stds = [std(biasData.ax), std(biasData.ay), std(biasData.az), std(biasData.gx), std(biasData.gy), std(biasData.gz), std(biasData.mx), std(biasData.my), std(biasData.mz)];
